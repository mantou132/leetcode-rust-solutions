...
fn test_drop() {
    ...
    {
        let stack = &mut Array::<Item>::with_capacity(5);
...
#[test]
fn test_stack() {
    common::stack::test_stack(&mut Array::<usize>::with_capacity(5));
}
...
fn test_stack_empty() {
    common::stack::test_empty(&mut Array::<usize>::with_capacity(5));
}
...
fn test_bounded_stack_overflow() {
    common::stack::test_bounded_overflow(&mut Array::<usize, FixedCapacity>::with_capacity(5));
}


#[test]
fn test_unbounded_stack_grow() {
    common::stack::test_unbounded_grow(&mut Array::<usize>::with_capacity(0));
}


#[test]
fn test_unbounded_stack_shrink() {
    common::stack::test_unbounded_shrink(&mut Array::<usize>::with_capacity(0));
}


#[test]
fn test_unbounded_reserve() {
    common::unbounded::test_reserve(&mut Array::<usize>::with_capacity(0));
}


#[test]
fn test_unbounded_shrink() {
    let stack = &mut Array::<usize>::with_capacity(0);
